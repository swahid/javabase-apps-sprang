		...
		<div class="login-page">
			<div class="form">
			  ...
			  <form class="register-form" id="registerForm" action="#" method="post">
			    ...
			    <p class="message">Already registered? <a href="javascript:void(0)" onclick="toggle_visibility(); return false;" class="message">Sign In</a></p>
			    </form>
			    <form class="login-form" action="<c:url value='/login' />" method="post">
			      ...
			      <button>login</button>
			      <p class="message">Not registered? <a href="javascript:void(0)" onclick="toggle_visibility(); return false;" class="message">Create an account</a></p>
			    </form>
			</div>
		</div>
